                ...
                <div class="col-lg-6 col-md-6">
                    <div class="cat-header-text small text-center">
                        <h1 class="fs-5 fw-bold">
                            Articles written by <q><?php echo get_the_author_meta("display_name"); ?></q>
                        </h1>
                        <?php echo get_the_author_meta("description"); ?>
                        <p>
                            Email me via <a href="mailto:<?php echo get_the_author_meta('email'); ?>"><?php echo get_the_author_meta('email'); ?></a>
                        </p>
                        <p>
                            Here is my portfolio on 
                            <a href="<?php echo get_the_author_meta('link'); ?>" target="_blank">
